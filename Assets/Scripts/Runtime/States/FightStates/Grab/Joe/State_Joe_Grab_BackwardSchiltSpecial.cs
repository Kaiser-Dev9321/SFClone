...
public class State_Joe_Grab_BackwardSchiltSpecial : JoeFighterState
{
    ...
    public override void State_Enter()
    {
        ...
        entity.fighterComboManager.attacked_Entity.entityHitstun.ActivateGroundHitstun(grabAttackEffectData.effect_Hitstun);
        ...
        entity.entityAnimator.PlayAnimation("SchiltSpecial");
    }
