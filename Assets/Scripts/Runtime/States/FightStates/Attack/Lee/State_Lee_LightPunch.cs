...
public class State_Lee_LightPunch : AttackFighterState
{
    ...
    public override void State_Update()
    {
        ...
        ButtonNormalsInTargetCombo(attackData, stateMachine_Lee.TC1_LightKick2, attackData.targetComboData[0]);
    }
