...
//TODO: Final Finisher states need another animation where Cody reels back if the attack gets blocked
public class State_Cody_LightFinalFinisher : FighterState
{
    ...
    public override void State_Update()
    {
        ...
        {
            print("Checking return to neutral");
