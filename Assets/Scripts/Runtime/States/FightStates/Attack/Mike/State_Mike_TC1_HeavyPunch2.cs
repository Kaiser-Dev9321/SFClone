...
public class State_Mike_TC1_HeavyPunch2 : AttackFighterState
{
    ...
    {
        ButtonNormalsInTargetCombo(attackData, stateMachine_Mike.TC1_FiercePunch2, attackData.targetComboData[0]);
