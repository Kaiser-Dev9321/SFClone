...
public class ArcadeFighterGameplayManager : FighterGameplayManager
{
    private void Awake()
    {
    ...
    private void LoadFighter2()
    {
        ...
        gameManager.fighter2.fighterSuperManager.ui_SuperMeter = fightersSuperEmpty.transform.GetChild(1).GetComponent<UI_SuperMeter>();
    ...
    private void LoadMatchEssentials()
    {
        ...
        cameraManager.ChangeCamera(cameraManager.fightersTargetSuperCam, cameraManager.startOfRoundCamera);
